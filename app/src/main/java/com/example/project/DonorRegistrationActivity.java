                                ...
                                if(resultUri !=null) {
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(DonorRegistrationActivity.this,"Image Upload",Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                    ...
                                    Intent intent=new Intent(DonorRegistrationActivity.this,screenActivity.class);
                                    startActivity(intent);
                                    finish();
                                    loader.dismiss();
